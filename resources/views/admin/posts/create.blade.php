...
@section('breadcrumbs') @include('partials.admin_breadcrumbs', ['breadcrumbs' => Breadcrumbs::generate('post.create')]) @endsection
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title-page" placeholder="Title" name="title" value="">
                                </div>
                                <div class="form-group">
                                    <label for="slug-page">{{ trans('admin.url') }}</label>
                                    <input type="text" class="form-control" id="slug-page" placeholder="URL" name="slug" value="">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    @foreach($rubrics as $rubric)
                                        <p>
                                        <label>
                                            <input type="checkbox" name="rubrics[]" value="{{ $rubric->id }}" />
                                             {{ $rubric->title }}
                                        </label>
                                        </p>
                                    @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="user-avatar" placeholder="" name="image" value="">
                                </div>
                                <div class="form-group">
                                    <label for="meta-title-page">{{ trans('admin.meta_title') }}</label>
                                    <input type="text" class="form-control" id="meta-title-page" placeholder="Meta title" name="meta_title" value="">
                                </div>
                                <div class="form-group">
